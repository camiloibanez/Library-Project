...
public class BookDaoImp implements BookDao{
	...
	private static String SELECT_BOOK_HISTORY = "SELECT * FROM book_checkout AS bkc INNER JOIN book AS bk ON bkc.isbn = bk.isbn WHERE bkc.patron_id = ? order by bkc.returned";
